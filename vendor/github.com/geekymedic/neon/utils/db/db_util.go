...
func (db *DB) Close() error {
	return errors.Wrap(db.db.Close())
}
...
func (stmt *Stmt) Close() error {
	return errors.Wrap(stmt.stmt.Close())
}
...
func (rows *Rows) Columns() ([]string, error) {
	...
	return strs, errors.Wrap(err)
}

func (rows *Rows) Close() error {
	return errors.Wrap(rows.rows.Close())
}

func (rows *Rows) Err() error {
	return errors.Wrap(rows.rows.Err())
}
